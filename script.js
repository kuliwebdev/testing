...
const sheetAppUrl = 'https://script.google.com/macros/s/AKfycbyMhM9vl0-DtBI3zkr1BEohcDwdDf3cksVYPp7l5V1AO7lLj48lhy0fCID6aSmeQkfq2A/exec'; 
...
async function sendDataToGoogleSheet() {
    try {
        ...
        ErrorMessageDiv.style.display = 'flex';
        ErrorMessage.textContent = 'Gagal Mengirim Data';
        ErrorMessageDiv.style.animation = 'FadeInTop .3s forwards'
